...
describe('Suíte de Testes', () => {
  ...
  test('3 mais 3', () => {
    expect(calcs.sum(3, 3)).toBeGreaterThan(5) ///maior que 5
    expect(calcs.sum(3, 3)).toBeGreaterThanOrEqual(6) ///maior ou igual a 6
    expect(calcs.sum(3, 3)).toBeLessThan(8) ///menor que 8
    expect(calcs.sum(3, 3)).toBeLessThanOrEqual(7) ///menor ou igual a 7
    expect(calcs.sum(3, 3)).not.toEqual(5) ///não igual a 5
  })
